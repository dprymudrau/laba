...
import main.java.com.solvd.laba.dao.util.XmlParse.ConfigUtils;
...
public class ConnectionPool {
    private static final Logger LOGGER = LogManager.getLogger(main.java.com.solvd.laba.dao.util.XmlParse.ConnectionPool.class);
    private static main.java.com.solvd.laba.dao.util.XmlParse.ConnectionPool instance;
    ...
    public static synchronized main.java.com.solvd.laba.dao.util.XmlParse.ConnectionPool getInstance() {
        if (instance == null) {
            instance = new main.java.com.solvd.laba.dao.util.XmlParse.ConnectionPool();
        }
        return instance;
    }
