...
public class Pilot {
    ...
    public boolean equals(Object o) {
        ...
        Pilot pilot = (Pilot) o;
        return idPilot == pilot.idPilot && workExperience == pilot.workExperience && pilotCategoryId == pilot.pilotCategoryId && pilotName.equals(pilot.pilotName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idPilot, pilotName, workExperience, pilotCategoryId);
    }
