...
INSERT Pilot(pilotCategoryId,pilotName,workExperience)
VALUES (2, "Pavlo", 5), (1, "Pavel", 2), (3, "Pshcevel", 15), (1, "Ne Pavlo", 3);

INSERT Pilot(pilotCategoryId,pilotName,workExperience)
VALUES (1, "Ne Pavlo", 3);

INSERT Flight(planeId,categoryId,fromAirportId,whereAirportId,price,flightDate)
VALUES (1, 1, 1, 2, 1000, '2038-01-20 03:14:07'), 
(2, 3, 2, 3, 300, '2038-01-19 03:14:07'),
(3, 2, 3, 2, 20000, '2038-04-19 03:14:07');

INSERT PilotInFlight(pilotId, flightId)
VALUES (1, 2), (2, 3), (3, 1);
